            ...
            <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
              <tr>
                <td style="background: #ffffff; padding: 40px 30px 0 30px; text-align: center;">
                  <img src="https://res.cloudinary.com/danzeqybu/image/upload/v1777550117/logo_cnn59u.png" alt="The Future Logo" style="width: 60px; height: 60px; margin-bottom: 12px;">
